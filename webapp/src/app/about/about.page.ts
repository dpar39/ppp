...
@Component({
  ...
  template: `
    ...
    <ion-content>
      ...
      <ion-list>
        <ion-item-divider>
          <ion-label class="ion-bold"> About </ion-label>
        </ion-item-divider>
        <ion-item>
          <ion-text color="medium ion-padding"
            >This app allows you to prepare photos for passport applications, and many other photo ID documents such as
            visas, employment authorization documents, etc.</ion-text
          >
        </ion-item>
        <ion-item-divider>
          <ion-label class="ion-bold"> App Build Info </ion-label>
        </ion-item-divider>
        ...
        <ion-item-divider>
          <ion-label> Developer Information </ion-label>
        </ion-item-divider>
        ...
        <ion-grid>
          ...
          <ion-row>
            <ion-col class="key"> Contact </ion-col>
          ...
          <ion-row>
            <ion-col>
              <ion-button expand="block"><ion-icon name="bug" class="ion-padding-end"></ion-icon>Submit bug</ion-button>
            </ion-col>
            <ion-col>
              <a
